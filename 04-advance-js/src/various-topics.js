...
//     // Overriding
//     getDetails() {
//         return `${this.age} - ${this.#salary} - ${Employee.companyName}`;
//     }
...
// let empTwo = new Employee("Bam", "Baz", 30, 12000);
// console.log(empOne.getDetails())
// console.log(empTwo.getDetails())

// console.log(Employee.getCompanyDetails())